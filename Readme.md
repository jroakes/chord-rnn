...
Code for this was borrowed :) from two variations that were implementing different features
* [larspars/word-rnn](https://github.com/larspars/word-rnn)
* [mtanana/char-rnn](https://github.com/mtanana/char-rnn)


# To DO

* Test other types of embeddings
* NLP processing for text
* Checkpoint sampling and perplexity measurements
